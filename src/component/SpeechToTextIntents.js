...
class SpeechToTextIntents extends Component {
  state = {
    error: "",
    interimText: "",
    finalisedText: [],
  ...
  getWeatherData = (inputStatement, lang) => {
    // axios
    ...
    const soundRes = "https://e7d59392774c.ngrok.io/audio/";
    axios
      // .get(`https://74d437c5351e.ngrok.io/weather/bridgeport/1`)
      .get(
        `https:///e7d59392774c.ngrok.io/user/${inputStatement}/${this.state.languageDest.substring(
          0,
          2
        )}`
      )
  ...
  getTranslation(word, destLang) {
    ...
    axios
      // .get(`https://74d437c5351e.ngrok.io/weather/bridgeport/1`)
      .get(
        `https://e7d59392774c.ngrok.io/transLang/${word}/${destLang.substring(
          0,
          2
        )}`
      )
  ...
  getData(finalText) {
    ...
    // var res = escape(finalText[0]);
    var res = finalText[0].replace(/ /g, "%20");
    console.log("Res:", res);

    this.getWeatherData(res, this.state.languageDest);

    // var res = finalText[0].split(" ").splice(-1)[0];

    // // var res = finalText[0].substring(26);
    // var wordCount = finalText[0].trim().split(/\s+/).length;
    // console.log("wordCount:", wordCount);
    // var temperatureStr = finalText[0].substring(11, 22);
    // console.log(temperatureStr);
    // //Check
    // if (temperatureStr === "temperature" && wordCount > 1) {
...
export default withWidth()(withStyles(styles)(SpeechToTextIntents));
